...
const FINANCE_ROUTE_LABELS: Partial<Record<FinanceView, { groupLabel: string; viewLabel: string }>> = {
  ...
  "repasses-profissional": { groupLabel: "NeuroFinance", viewLabel: "Conta de destino" },
  "tarifas": { groupLabel: "NeuroFinance", viewLabel: "Custos e prazos" },
};

const NeuroFinanceActivationScreen = ({ onStart }: { onStart: () => void }) => (
  <div className="px-6 py-6">
    <div className="finance-panel relative overflow-hidden rounded-[34px] border border-border/60 bg-card/[0.78] p-8 text-card-foreground shadow-[0_28px_90px_-70px_rgba(0,0,0,0.42)] backdrop-blur-xl dark:border-black/75 dark:bg-zinc-900/[0.52] dark:shadow-[0_30px_92px_-58px_rgba(0,0,0,0.98)] md:p-12">
      ...
      <div className="relative z-10 grid gap-10 xl:grid-cols-[minmax(0,1fr)_390px] xl:items-end">
        <div>
          <div className="inline-flex items-center gap-2.5 rounded-full border border-border/60 bg-background/55 px-4 py-2 text-[9px] font-black uppercase tracking-[0.24em] text-muted-foreground dark:border-black/70 dark:bg-black/[0.28]">
        ...
        <div className="finance-inset rounded-[28px] border border-border/60 bg-background/[0.62] p-6 shadow-sm dark:border-black/75 dark:bg-black/[0.28] dark:shadow-[0_20px_54px_-42px_rgba(0,0,0,0.96)]">
