...
export const DesktopSessionWorkspace = ({
  ...
  return (
    <aside className="flex h-full min-h-0 min-w-0 flex-col gap-4" aria-label="Ferramentas clínicas da sessão">
      <MagneticSegmentedControl
        ...
        className="teleconsultation-surface grid w-full shrink-0 grid-cols-3 rounded-[20px] p-2"
        triggerClassName="teleconsultation-action min-h-10 w-full min-w-0 px-2.5 text-[8px] font-black uppercase tracking-[0.1em]"
      />
      ...
      <section className="teleconsultation-surface min-h-0 flex-1 overflow-hidden rounded-[27px]">
        ...
        {activeTab === 'transcript' ? (
          <div data-synapse-target="teleconsultation-workspace-transcript" className="flex h-full min-h-0 flex-col">
            <header className="flex shrink-0 items-start justify-between gap-4 border-b border-border/40 px-6 py-5 dark:border-white/[0.045]">
              <div>
            ...
            <div className="flex shrink-0 items-center gap-2.5 border-b border-border/30 px-6 py-3 text-[8px] font-black uppercase tracking-[0.12em] text-muted-foreground dark:border-white/[0.035]">
            ...
            <div className="teleconsultation-scroll min-h-0 flex-1 overflow-y-auto p-5">
              {segments.length ? (
                <div className="space-y-3">
                  {segments.map((segment) => (
                    <article
                      key={segment.client_segment_id}
                      className="teleconsultation-inset teleconsultation-deferred-section rounded-[19px] p-4"
                    >
          ...
          <div data-synapse-target="teleconsultation-workspace-notes" className="flex h-full min-h-0 flex-col">
            ...
            <div className="min-h-0 flex-1 p-5">
              <Textarea
                ...
                className="teleconsultation-inset h-full min-h-0 resize-none rounded-[21px] border-0 p-5 text-sm leading-relaxed shadow-none focus-visible:ring-2"
              />
            </div>
          </div>
        ) : null}
        ...
        {activeTab === 'patient' ? (
          <div data-synapse-target="teleconsultation-workspace-patient" className="teleconsultation-scroll h-full min-h-0 overflow-y-auto p-6">
            ...
            <div className="mt-5 space-y-4">
              <div className="teleconsultation-inset rounded-[20px] p-5">
