...
const DesktopFinanceiro = () => {
  ...
  return (
    <div className="finance-desktop desktop-lumen-page desktop-content-offset relative flex min-h-screen w-full flex-col bg-transparent font-sans text-foreground selection:bg-primary/20">
      <NewTransactionModal
        open={agentTransactionModalOpen}
        onOpenChange={setAgentTransactionModalOpen}
        showTrigger={false}
      />
      <div className="relative z-10 mx-auto flex w-full max-w-[2200px] flex-1 gap-5 px-5 pb-10 md:px-7 lg:gap-7 lg:px-10 xl:px-14 2xl:gap-8 2xl:px-16">
        <nav
        ...
        >
          <motion.div
            ...
            className="finance-sidebar-surface sticky top-10 flex max-h-[calc(100vh-5rem)] flex-col overflow-hidden rounded-[30px] border border-border/60 bg-card/[0.82] p-3.5 shadow-[0_24px_74px_-54px_hsl(var(--foreground)/0.42)] ring-1 ring-foreground/[0.02] backdrop-blur-2xl dark:border-white/[0.07] dark:bg-zinc-950/[0.88] dark:shadow-[0_28px_80px_-52px_rgba(0,0,0,0.96)] dark:ring-white/[0.02]"
          >
            ...
            <div className={cn("relative z-10 flex flex-col gap-2.5 overflow-y-auto overflow-x-hidden no-scrollbar", showSidebarDetails ? "pr-1" : "items-center pr-0")}>
                ...
                return (
                  <div key={group.id} className="flex flex-col gap-1 rounded-[22px]">
                    ...
                    <button
                      ...
                      className={cn(
                        "group relative flex min-h-12 items-center rounded-2xl transition-[background-color,color,box-shadow,transform] duration-200 ease-out active:scale-[0.985] motion-reduce:transition-none motion-reduce:active:scale-100",
        ...
        <div
          ...
          className="finance-frame relative min-w-0 flex-1 overflow-hidden rounded-[40px] border border-border/45 bg-card/[0.42] shadow-[0_22px_90px_-76px_hsl(var(--foreground)/0.45)] backdrop-blur-sm dark:border-white/[0.055] dark:bg-black/[0.28] dark:shadow-[0_28px_96px_-68px_rgba(0,0,0,0.98)]"
        >
